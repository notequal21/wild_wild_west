const faqList = [
  ...
  {
    question: 'What’s the future development of this meme token?     ',
    answer: [
      `Well, let us assure you that we're firmly routed in the Wild Wild West of crypto for the sheer joy and adventure it brings. We're not in the business of hasty token sales or questionable practices that plague 99% of the corners of this space. Instead, we're here to surf the unpredictable waves, foster a robust and vibrant community – because in crypto, community is king – and have a blast while doing it. Oh, and we might just have a few surprises up our sleeves, secrets we'll unveil in due course. Remember, it's not just about the tech; it's about the strength of our community. So, saddle up, join our posse, and let's ride this crypto rodeo all the way to the moon!" 🤠🚀🌕
      `,
    ],
  },
];
